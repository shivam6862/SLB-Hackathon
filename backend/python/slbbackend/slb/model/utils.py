...
class LLM:
    ...
    def generate_response(self, prompt, max_length=50, temperature=0.7):
        ...
        if self.model is not None:  # If model loading was successful
            ...
            print(
                "Model loading failed. Please try again with a smaller model or alternative approach.")
    ...
    def get_llm(self):
        ...
        try:
            ...
            if "out of memory" in str(e):
                print(
                    "Full Bloom-7B model might not fit on GPU. Trying to load a smaller section...")
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(
            "bigscience/bloom-7b1", add_bos_token=True,)
